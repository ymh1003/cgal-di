...
// #endif
#ifdef CGAL_NO_ATOMIC
long defBigFloatOutputDigits = 67;
#else
std::atomic<long> defBigFloatOutputDigits(67);
#endif
...
// #endif
#ifdef CGAL_NO_ATOMIC
long defOutputDigits = 67;
#else
std::atomic<long> defOutputDigits(67); // == defBigFloatOutputDigits;
#endif
...
// #endif
#ifdef CGAL_NO_ATOMIC
long defBigFloatInputDigits = 67;
#else
std::atomic<long> defBigFloatInputDigits(67);
#endif
...
// #endif
#ifdef CGAL_NO_ATOMIC
long defInitialProgressivePrec = 500;
#else
std::atomic<long> defInitialProgressivePrec(500);
#endif
