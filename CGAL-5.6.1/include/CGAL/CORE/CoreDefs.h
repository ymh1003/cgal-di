...
CGAL_GLOBAL_STATE_VAR(extLong, defRelPrec, 200)
...
// #endif
#ifdef CGAL_NO_ATOMIC
    CGAL_GLOBAL_STATE_VAR(long, defBigFloatOutputDigits, 67)
#else
    CGAL_GLOBAL_STATE_VAR(std::atomic<long>, defBigFloatOutputDigits, 67)
#endif
...
// #endif
#ifdef CGAL_NO_ATOMIC
CGAL_GLOBAL_STATE_VAR(long, defOutputDigits, 67) // == get_static_defBigFloatOutputDigits()
#else
CGAL_GLOBAL_STATE_VAR(std::atomic<long>, defOutputDigits, 67) // == get_static_defBigFloatOutputDigits()
#endif
...
// #endif
#ifdef CGAL_NO_ATOMIC
CGAL_GLOBAL_STATE_VAR(long, defBigFloatInputDigits, 100)
#else
CGAL_GLOBAL_STATE_VAR(std::atomic<long>, defBigFloatInputDigits, 100)
#endif
...
/// default BigFloat Division Relative Precision
CGAL_GLOBAL_STATE_VAR(extLong, defBFdivRelPrec, 200)
/// default BigFloat Sqrt Absolute Precision
CGAL_GLOBAL_STATE_VAR(extLong, defBFsqrtAbsPrec, 200)
...
/// default initial (bit) precision for AddSub Progressive Evaluation
#ifdef CGAL_NO_ATOMIC
CGAL_GLOBAL_STATE_VAR(long, defInitialProgressivePrec, 200)
#else
CGAL_GLOBAL_STATE_VAR(std::atomic<long>, defInitialProgressivePrec, 200)
#endif
